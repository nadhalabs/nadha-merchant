...
# This enum is created and owned by the phase-1 schema.  Diary only references
# it; this migration must never create or drop the shared PostgreSQL type.
